...
This image is based on node:6.10.0-alpine ([AWS Lambda uses Node v6.10.0](http://docs.aws.amazon.com/lambda/latest/dg/current-supported-versions.html)) and has the AWS CLI, Serverless v1.33.2 and Yarn installed.
